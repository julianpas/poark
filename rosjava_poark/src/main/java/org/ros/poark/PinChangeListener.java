...
public interface PinChangeListener {
  ...
  /**
   * Called every time the pin has changed its value.
   * @param pin Pin that has changed.
   * @param newValue The new value of the pin.
   */
  void onPinStateChange(byte pin, int newValue);
}
